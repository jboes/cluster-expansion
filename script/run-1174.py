...
images = Trajectory("/home-research/jboes/research/cluster-expansion/script/out-1174.traj", "r")
atoms = images[-1]

# db = connect("/home-research/jboes/research/cluster-expansion/temp/vegard-3x3.db")
# atoms = db.get_atoms(1174)
...
traj = Trajectory("/home-research/jboes/research/cluster-expansion/script/out-1174.traj", "a", atoms)
