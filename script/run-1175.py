...
images = Trajectory("/home-research/jboes/research/cluster-expansion/script/out-1175.traj", "r")
atoms = images[-1]

# db = connect("/home-research/jboes/research/cluster-expansion/temp/vegard-3x3.db")
# atoms = db.get_atoms(1175)
...
traj = Trajectory("/home-research/jboes/research/cluster-expansion/script/out-1175.traj", "a", atoms)
