...
#+RESULTS:
: <async:a4b01088959f75971c1ba07b35f525de>
...
#+caption: Dual neural network validation for 7 layer slabs of 1 \times 1, 2 \times 1, and r3 \times r3 energy unique configuration as predicted by EMT. Validations are made for the third instance of the database (db2) which contains all 2085 configurations.
#+attr_org: :width 600
