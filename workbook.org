...
l2n20i0      R        4557     2.604e-03
l2n25i1      N        3576     5.001e-03
l2n30i0      R        4852     2.483e-03
l2n30i1      R        4319     2.669e-03
l2n35i0      R        4181     5.401e-03
l2n35i1      R        4134     3.715e-03
l2n40i0      R        3914     3.739e-03
l2n40i1      R        3892     2.625e-03
l3n25i0      R        3615     1.658e-03
l3n25i1      R        3630     1.730e-03
l3n30i0      R        3964     1.350e-03
l3n30i1      R        3975     1.696e-03
l3n35i0      R        Saving   checkpoint
l3n35i1      R        3773     1.522e-03
l3n40i0      R        3596     1.674e-03
l3n40i1      R        3586     1.699e-03
#+end_example
            ...
            for cell in cells:
                ...
                with jasp(nwd,
                    ...
                    try:
                        ...
                        atoms = calc.get_atoms()
<<<<<<< HEAD
                        nrg = calc.get_potential_energy()
                        print nrg
=======
                        nrg = atoms.get_potential_energy()
                        cnt += 1
>>>>>>> 5e1d3351d549219e9abc2262ae37db11bf91baf8
                    except(VaspSubmitted, VaspQueued):
                        pass
...
ax0.text(100, 0.145, 'RMSE: {0:1.3f}'.format(RMSE), fontsize=15, va='top', ha='left')
...
n, bins, patches = ax1.hist(dif, 200,
                            range=(-0.5, 0.5),
                            normed=True,
                            facecolor='k',
                            alpha=0.5,
...
ax1.text(1, 0.145, '$\mu$: {0:1.3f}'.format(mu), fontsize=15, va='top', ha='left')
ax1.text(1, 0.13, '$\sigma$: {0:1.3f}'.format(sigma), fontsize=15, va='top', ha='left')
...
plt.savefig('./images/db5-train.png')
#+END_SRC
