...
dirs = glob.glob('DFT/surf=fcc/host=*/lattice=3.634/type=layers3')
...
print('{0} total complete'.format(cnt + len(d)))
print('{0} jobs incomplete'.format(len(d)))
print('{0} jobs complete'.format(cnt))
#+END_SRC
