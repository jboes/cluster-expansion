...
#+RESULTS:
#+begin_example
keyword          value           1352 calculations total
---------------------------------------------------------
xc             : PBE
ca             : 1.5, 1.0, 0.94, 1.26, 1.46, 1.14, 1.02, 1.42, 1.41421356, 1.4, etc...
encut          : 400.0
strain         : xyz
ibz_kpts       : 128, 64, 98, 35, 196, 42, 75, 205, 80, 146, etc...
nbands         : 25, 50, 37, 14
ediff          : 1e-08
total_energy   : -8.4153976, -9.8549079, -9.6299781, -40.878829, -8.7195167, -8.9047240, -3.0571126, -10.434188, -9.9068297, -10.112720, etc...
...
volume         : 18.4375, 18.125, 35.1, 21.3871537, 25.3211443, 15.0, 63.6313884, 22.4073792, 18.7041171, 20.6317065, etc...
traj           : 0
fermi          : 6.0791, 6.5838, 8.0371, 7.9801, 16.0877, 11.889, 6.0098, -0.7019, 6.0859, 8.9644, etc...
kppra          : 1728
calc_time      : 53.75, 84.875, 55.465, 45.528, 92.959, 62.25, 323.755, 53.806, 76.491, 60.319, etc...
#+end_example
...
* Working with surface structures
#+BEGIN_SRC python
from ase.lattice.surface import fcc111_root
from ase.visualize import view
...
for b in basis:
    B, I = b[0], b[1]
    for i, cfg in cfgs.iteritems():
        for j, comp in enumerate(cfg):
            atoms = fcc111_root(B, 7, [1, 1, 5], vacuum=6)
            for k in comp:
                atoms[k].symbol = I
            ...
            wd = 'DFT/surf=fcc/host={0}/guest={1}/gcnt={2}/config={3}/'.format(B, I, i, j)
            with jasp(wd,
                      xc='PBE',
                      gga='PS',
                      encut=400,
