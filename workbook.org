...
for cfg in cfgs:
    atoms = fcc111_root('Cu', 7, size=(1, 1, 5), vacuum=6.0, a=3.787)
    atoms[22].symbol = 'Pd'
    atoms[24].symbol = 'Pd'
    atoms[25].symbol = 'Pd'
...
for i in range(natoms + 1):
    subset = i*[metals[0]] + (natoms - i)*[metals[1]]

    perm = permutations(subset, natoms)
...
[['Pd' 'Pd' 'Pd' 'Pd' 'Pd' 'Pd' 'Pd']
 ['Pd' 'Pd' 'Pd' 'Pd' 'Pd' 'Pd' 'Cu']
 ['Pd' 'Cu' 'Pd' 'Pd' 'Pd' 'Pd' 'Pd']
 ['Pd' 'Pd' 'Pd' 'Cu' 'Pd' 'Pd' 'Pd']
 ['Pd' 'Pd' 'Cu' 'Pd' 'Pd' 'Pd' 'Pd']
 ['Pd' 'Pd' 'Pd' 'Pd' 'Cu' 'Pd' 'Pd']
 ['Pd' 'Pd' 'Pd' 'Pd' 'Pd' 'Cu' 'Pd']
 ['Cu' 'Pd' 'Pd' 'Pd' 'Pd' 'Pd' 'Pd']
 ['Cu' 'Pd' 'Pd' 'Pd' 'Cu' 'Pd' 'Pd']
 ['Pd' 'Pd' 'Pd' 'Pd' 'Cu' 'Cu' 'Pd']
 ['Pd' 'Pd' 'Cu' 'Pd' 'Pd' 'Cu' 'Pd']
 ['Pd' 'Pd' 'Pd' 'Pd' 'Pd' 'Cu' 'Cu']
 ['Pd' 'Pd' 'Pd' 'Pd' 'Cu' 'Pd' 'Cu']
 ['Cu' 'Cu' 'Pd' 'Pd' 'Pd' 'Pd' 'Pd']
 ['Pd' 'Cu' 'Cu' 'Pd' 'Pd' 'Pd' 'Pd']
 ['Pd' 'Pd' 'Pd' 'Cu' 'Pd' 'Pd' 'Cu']
 ['Pd' 'Pd' 'Pd' 'Cu' 'Pd' 'Cu' 'Pd']
 ['Pd' 'Pd' 'Cu' 'Pd' 'Pd' 'Pd' 'Cu']
 ['Pd' 'Cu' 'Pd' 'Cu' 'Pd' 'Pd' 'Pd']
 ['Cu' 'Pd' 'Pd' 'Pd' 'Pd' 'Cu' 'Pd']
 ['Pd' 'Pd' 'Cu' 'Pd' 'Cu' 'Pd' 'Pd']
 ['Pd' 'Cu' 'Pd' 'Pd' 'Pd' 'Pd' 'Cu']
 ['Cu' 'Pd' 'Pd' 'Cu' 'Pd' 'Pd' 'Pd']
 ['Cu' 'Pd' 'Cu' 'Pd' 'Pd' 'Pd' 'Pd']
 ['Pd' 'Cu' 'Pd' 'Pd' 'Cu' 'Pd' 'Pd']
 ['Pd' 'Pd' 'Pd' 'Cu' 'Cu' 'Pd' 'Pd']
 ['Cu' 'Pd' 'Pd' 'Pd' 'Pd' 'Pd' 'Cu']
 ['Pd' 'Cu' 'Pd' 'Pd' 'Pd' 'Cu' 'Pd']
 ['Pd' 'Pd' 'Cu' 'Cu' 'Pd' 'Pd' 'Pd']
 ['Pd' 'Cu' 'Cu' 'Cu' 'Pd' 'Pd' 'Pd']
 ['Pd' 'Pd' 'Pd' 'Cu' 'Cu' 'Cu' 'Pd']
 ['Pd' 'Pd' 'Cu' 'Cu' 'Cu' 'Pd' 'Pd']
 ['Pd' 'Pd' 'Cu' 'Cu' 'Pd' 'Pd' 'Cu']
 ['Pd' 'Cu' 'Cu' 'Pd' 'Pd' 'Pd' 'Cu']
 ['Pd' 'Cu' 'Pd' 'Cu' 'Pd' 'Pd' 'Cu']
 ['Cu' 'Cu' 'Pd' 'Cu' 'Pd' 'Pd' 'Pd']
 ['Cu' 'Pd' 'Cu' 'Pd' 'Pd' 'Cu' 'Pd']
 ['Pd' 'Cu' 'Cu' 'Pd' 'Pd' 'Cu' 'Pd']
 ['Cu' 'Pd' 'Cu' 'Pd' 'Pd' 'Pd' 'Cu']
 ['Cu' 'Pd' 'Cu' 'Cu' 'Pd' 'Pd' 'Pd']
 ['Cu' 'Cu' 'Cu' 'Pd' 'Pd' 'Pd' 'Pd']
 ['Pd' 'Cu' 'Pd' 'Pd' 'Cu' 'Cu' 'Pd']
 ['Cu' 'Cu' 'Pd' 'Pd' 'Pd' 'Cu' 'Pd']
 ['Pd' 'Cu' 'Pd' 'Cu' 'Cu' 'Pd' 'Pd']
 ['Pd' 'Pd' 'Cu' 'Pd' 'Pd' 'Cu' 'Cu']
 ['Pd' 'Cu' 'Pd' 'Cu' 'Pd' 'Cu' 'Pd']
 ['Cu' 'Pd' 'Pd' 'Pd' 'Cu' 'Pd' 'Cu']
 ['Pd' 'Cu' 'Pd' 'Pd' 'Pd' 'Cu' 'Cu']
 ['Pd' 'Pd' 'Pd' 'Cu' 'Cu' 'Pd' 'Cu']
 ['Pd' 'Pd' 'Cu' 'Cu' 'Pd' 'Cu' 'Pd']
 ['Cu' 'Pd' 'Pd' 'Cu' 'Cu' 'Pd' 'Pd']
 ['Cu' 'Pd' 'Pd' 'Cu' 'Pd' 'Cu' 'Pd']
 ['Pd' 'Pd' 'Pd' 'Cu' 'Pd' 'Cu' 'Cu']
 ['Pd' 'Cu' 'Cu' 'Pd' 'Cu' 'Pd' 'Pd']
 ['Cu' 'Pd' 'Pd' 'Pd' 'Cu' 'Cu' 'Pd']
 ['Pd' 'Pd' 'Pd' 'Pd' 'Cu' 'Cu' 'Cu']
 ['Pd' 'Pd' 'Cu' 'Pd' 'Cu' 'Pd' 'Cu']
 ['Cu' 'Pd' 'Pd' 'Cu' 'Pd' 'Pd' 'Cu']
 ['Cu' 'Cu' 'Pd' 'Pd' 'Pd' 'Pd' 'Cu']
 ['Cu' 'Cu' 'Pd' 'Pd' 'Cu' 'Pd' 'Pd']
 ['Cu' 'Pd' 'Cu' 'Pd' 'Cu' 'Pd' 'Pd']
 ['Pd' 'Cu' 'Pd' 'Pd' 'Cu' 'Pd' 'Cu']
 ['Cu' 'Pd' 'Pd' 'Pd' 'Pd' 'Cu' 'Cu']
 ['Pd' 'Pd' 'Cu' 'Pd' 'Cu' 'Cu' 'Pd']
 ['Cu' 'Cu' 'Cu' 'Pd' 'Pd' 'Pd' 'Cu']
 ['Cu' 'Pd' 'Cu' 'Pd' 'Pd' 'Cu' 'Cu']
 ['Pd' 'Cu' 'Pd' 'Cu' 'Cu' 'Pd' 'Cu']
 ['Pd' 'Pd' 'Cu' 'Cu' 'Cu' 'Cu' 'Pd']
 ['Cu' 'Pd' 'Cu' 'Cu' 'Pd' 'Cu' 'Pd']
 ['Cu' 'Cu' 'Pd' 'Pd' 'Cu' 'Pd' 'Cu']
 ['Cu' 'Pd' 'Pd' 'Cu' 'Cu' 'Pd' 'Cu']
 ['Cu' 'Cu' 'Pd' 'Cu' 'Pd' 'Cu' 'Pd']
 ['Cu' 'Cu' 'Pd' 'Cu' 'Cu' 'Pd' 'Pd']
 ['Cu' 'Pd' 'Pd' 'Pd' 'Cu' 'Cu' 'Cu']
 ['Cu' 'Pd' 'Pd' 'Cu' 'Pd' 'Cu' 'Cu']
 ['Pd' 'Cu' 'Cu' 'Cu' 'Pd' 'Cu' 'Pd']
 ['Pd' 'Cu' 'Cu' 'Cu' 'Pd' 'Pd' 'Cu']
 ['Cu' 'Cu' 'Pd' 'Pd' 'Cu' 'Cu' 'Pd']
 ['Pd' 'Cu' 'Pd' 'Cu' 'Pd' 'Cu' 'Cu']
 ['Cu' 'Pd' 'Cu' 'Pd' 'Cu' 'Pd' 'Cu']
 ['Cu' 'Pd' 'Cu' 'Pd' 'Cu' 'Cu' 'Pd']
 ['Pd' 'Cu' 'Pd' 'Pd' 'Cu' 'Cu' 'Cu']
 ['Pd' 'Pd' 'Cu' 'Cu' 'Pd' 'Cu' 'Cu']
 ['Cu' 'Cu' 'Pd' 'Cu' 'Pd' 'Pd' 'Cu']
 ['Pd' 'Cu' 'Cu' 'Cu' 'Cu' 'Pd' 'Pd']
 ['Pd' 'Cu' 'Pd' 'Cu' 'Cu' 'Cu' 'Pd']
 ['Pd' 'Cu' 'Cu' 'Pd' 'Cu' 'Pd' 'Cu']
 ['Cu' 'Cu' 'Cu' 'Cu' 'Pd' 'Pd' 'Pd']
 ['Pd' 'Pd' 'Pd' 'Cu' 'Cu' 'Cu' 'Cu']
 ['Pd' 'Pd' 'Cu' 'Pd' 'Cu' 'Cu' 'Cu']
 ['Pd' 'Cu' 'Cu' 'Pd' 'Pd' 'Cu' 'Cu']
 ['Cu' 'Pd' 'Pd' 'Cu' 'Cu' 'Cu' 'Pd']
 ['Cu' 'Pd' 'Cu' 'Cu' 'Cu' 'Pd' 'Pd']
 ['Cu' 'Cu' 'Cu' 'Pd' 'Cu' 'Pd' 'Pd']
